...
// ============================================
// UTILITÁRIOS (mesmos do script.js principal)
// ============================================
...
// ============================================
// CARREGAR PERFIL PELO SLUG NA URL
// ============================================
...
function renderNaoEncontrado() {
    $('#profile-content').innerHTML = `
        <div class="profile-error">
            ...
            <p>Este perfil não existe, foi removido, ou ainda está a aguardar aprovação.</p>
            <a href="index.html" class="btn-primary"><i class="fas fa-search"></i> Ver todos os professores</a>
        </div>
    `;
}
...
async function carregarPerfil() {
    ...
    try {
        ...
        if (metaDesc) {
            metaDesc.setAttribute('content', `${data.name} ensina ${(data.instruments || []).join(', ')} em ${escapeHtml(data.neighborhood || '')}, ${escapeHtml(data.province || '')}. Contacta via AulaPerto.`);
        }
    } catch (err) {
